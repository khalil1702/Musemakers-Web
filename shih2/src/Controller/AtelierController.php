...
class AtelierController extends AbstractController
{
    ...
    #[Route('/{idAtelier}', name: 'app_atelier_show', methods: ['GET'])]
    ...
    #[Route('/{idAtelier}/edit', name: 'app_atelier_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idAtelier}', name: 'app_atelier_delete', methods: ['POST'])]
    public function delete(Request $request, Atelier $atelier, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$atelier->getIdAtelier(), $request->request->get('_token'))) {
